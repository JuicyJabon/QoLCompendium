...
namespace QoLCompendium.Content.Items.Placeables.CraftingStations.CrossMod.Calamity
{
    ...
    public class HardmodeCalamityCraftingMonolith : ModItem, ILocalizedModType
    {
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<AshenAltar>());
            r.AddIngredient(ModContent.ItemType<PlagueInfuser>());
            r.AddIngredient(ModContent.ItemType<VoidCondenser>());
            r.Register();
        }
    }
}