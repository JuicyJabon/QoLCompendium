namespace QoLCompendium.Content.Items.Tools.Summons.CrossMod.HomewardJourney
{
    ...
    public class ScarabBeliefSummon : BaseSummon
    {
        ...
        public override int NPCType => Common.GetModNPC(CrossModSupport.HomewardJourney.Mod, "ScarabBelief");
        public override int Rarity => ItemRarityID.Red;

        public override bool CanUseItem(Player player)
        {
            return CrossModSupport.HomewardJourney.Loaded && ModConditions.DownedLifebringer.IsMet() && ModConditions.DownedMaterealizer.IsMet() && ModConditions.DownedOverwatcher.IsMet() && !NPC.AnyNPCs(Common.GetModNPC(CrossModSupport.HomewardJourney.Mod, "ScarabBelief"));
        }
