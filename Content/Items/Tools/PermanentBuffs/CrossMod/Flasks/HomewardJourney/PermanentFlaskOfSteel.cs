...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Flasks.HomewardJourney
{
    ...
    public class PermanentFlaskOfSteel : IPermanentModdedBuffItem
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.homewardJourneyMod, Common.GetModBuff(ModConditions.homewardJourneyMod, "Flask_SteelBuff"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Common.GetModItem(ModConditions.homewardJourneyMod, "SteelFlask"), 30);
        ...
        internal override void ApplyBuff(PermanentBuffPlayer player)
        {
            ...
            player.modPotionEffects.Add(new WeaponImbueSteelEffect());
        }
    }
}
