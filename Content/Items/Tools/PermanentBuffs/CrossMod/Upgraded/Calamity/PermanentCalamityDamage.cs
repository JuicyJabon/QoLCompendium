...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentCalamityDamage";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentAstralInjection>());
            r.AddIngredient(ModContent.ItemType<PermanentShadow>());
