...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentCalamityDefense";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentBaguette>());
            r.AddIngredient(ModContent.ItemType<PermanentBloodfin>());
            r.AddIngredient(ModContent.ItemType<PermanentPhotosynthesis>());
            r.AddIngredient(ModContent.ItemType<PermanentTesla>());
