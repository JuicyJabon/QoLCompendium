...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Calamity
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentCalamityMovement";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentBounding>());
            r.AddIngredient(ModContent.ItemType<PermanentCalcium>());
            r.AddIngredient(ModContent.ItemType<PermanentGravityNormalizer>());
            r.AddIngredient(ModContent.ItemType<PermanentSoaring>());
