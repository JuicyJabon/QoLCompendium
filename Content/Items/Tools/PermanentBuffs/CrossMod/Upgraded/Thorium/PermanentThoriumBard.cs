...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentThoriumBard";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentCreativity>());
            r.AddIngredient(ModContent.ItemType<PermanentEarworm>());
            r.AddIngredient(ModContent.ItemType<PermanentInspirationalReach>());
