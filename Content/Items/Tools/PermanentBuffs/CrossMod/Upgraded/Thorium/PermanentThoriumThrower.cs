...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Upgraded.Thorium
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentThoriumThrower";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentAssassin>());
            r.AddIngredient(ModContent.ItemType<PermanentHydration>());
