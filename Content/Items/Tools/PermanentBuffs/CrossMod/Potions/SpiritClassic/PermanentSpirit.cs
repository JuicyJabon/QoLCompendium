...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SpiritClassic
{
    ...
    public class PermanentSpirit : IPermanentModdedBuffItem
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.spiritClassicMod, Common.GetModBuff(ModConditions.spiritClassicMod, "SpiritBuff"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Common.GetModItem(ModConditions.spiritClassicMod, "SpiritPotion"), 30);
        ...
        internal override void ApplyBuff(PermanentBuffPlayer player)
        {
            ...
            player.modPotionEffects.Add(new SpiritEffect());
        }
    }
}
