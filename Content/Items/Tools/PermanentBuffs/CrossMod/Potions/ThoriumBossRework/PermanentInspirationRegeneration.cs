...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.ThoriumBossRework
{
    ...
    public class PermanentInspirationRegeneration : IPermanentModdedBuffItem
    {
        ...
        public override string Texture => Common.ModBuffAsset(ModConditions.thoriumBossReworkMod, ModContent.BuffType<Inspired>());
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<InspirationRegenerationPotion>(), 30);
