...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.Thorium
{
    ...
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.thoriumMod, Common.GetModBuff(ModConditions.thoriumMod, "SkeletonRepellentBuff"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Common.GetModItem(ModConditions.thoriumMod, "SkeletonRepellent"), 30);
