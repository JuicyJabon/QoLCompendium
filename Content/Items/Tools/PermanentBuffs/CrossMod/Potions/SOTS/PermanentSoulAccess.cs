...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.SOTS
{
    ...
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.secretsOfTheShadowsMod, Common.GetModBuff(ModConditions.secretsOfTheShadowsMod, "SoulAccess"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Common.GetModItem(ModConditions.secretsOfTheShadowsMod, "SoulAccessPotion"), 30);
