...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.MartinsOrder
{
    ...
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.martainsOrderMod, Common.GetModBuff(ModConditions.martainsOrderMod, "Gourmet"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddRecipeGroup("QoLCompendium:GourmetFlavor", 30);
