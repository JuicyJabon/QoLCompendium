...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.CrossMod.Potions.HomewardJourney
{
    ...
    public class PermanentYang : IPermanentModdedBuffItem
    {
        public override string Texture => Common.ModBuffAsset(ModConditions.homewardJourneyMod, Common.GetModBuff(ModConditions.homewardJourneyMod, "YangPotionBuff"));
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(Common.GetModItem(ModConditions.homewardJourneyMod, "YangPotion"), 30);
        ...
        internal override void ApplyBuff(PermanentBuffPlayer player)
        {
            ...
            player.modPotionEffects.Add(new YangEffect());
        }
    }
}
