...
namespace QoLCompendium.Content.Items.Tools.PermanentBuffs.Upgraded
{
    ...
    {
        public override string Texture => "QoLCompendium/Assets/Items/PermanentConstruction";
        ...
        public override void AddRecipes()
        {
            ...
            r.AddIngredient(ModContent.ItemType<PermanentBuilder>());
            r.AddIngredient(ModContent.ItemType<PermanentCalm>());
            r.AddIngredient(ModContent.ItemType<PermanentMining>());
