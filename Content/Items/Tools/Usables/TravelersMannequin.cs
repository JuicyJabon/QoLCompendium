...
namespace QoLCompendium.Content.Items.Tools.Usables
{
    public class TravelersMannequin : ModItem, ILocalizedModType
    {
        ...
        {
            ItemUtils.ItemDisabledTooltip(Item, tooltips, QoLCompendium.itemConfig.TravelersMannequin);
        }

        public override void AddRecipes()
        {
            Recipe r = RecipeUtils.GetItemRecipe(() => QoLCompendium.itemConfig.TravelersMannequin, Type, 1, "Mods.QoLCompendium.ItemToggledConditions.ItemEnabled");
