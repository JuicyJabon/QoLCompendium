...
namespace QoLCompendium.Content.Items.Tools.Usables
{
    public class SkeletonRucksack : ModItem, ILocalizedModType
    {
        ...
        {
            ItemUtils.ItemDisabledTooltip(Item, tooltips, QoLCompendium.itemConfig.SkeletonRucksack);
        }

        public override void AddRecipes()
        {
            Recipe r = RecipeUtils.GetItemRecipe(() => QoLCompendium.itemConfig.SkeletonRucksack, Type, 1, "Mods.QoLCompendium.ItemToggledConditions.ItemEnabled");
