namespace QoLCompendium.Content.Projectiles.Explosives
{
    ...
    {
        public override string Texture => "QoLCompendium/Content/Items/Tools/Explosives/Hellbridger";
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int x = Main.maxTilesX / 2; x < Main.maxTilesX; x++)
            {
                ...
                for (int y = -30; y <= 0; y++)
                {
                    ...
                    if (!CheckDestruction.OkayToDestroyTile(tile, ignoreModdedTiles: true))
                        stopRight = true;
