...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class AetherPylonTile : ModPylon
    {
        ...
        {
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.White * 0.1f, ColorUtils.ColorSwap(Color.MediumOrchid, Color.MediumSlateBlue, 1.5f), 4, CrystalVerticalFrameCount);
        }
