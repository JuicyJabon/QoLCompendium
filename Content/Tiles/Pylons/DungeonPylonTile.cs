...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class DungeonPylonTile : ModPylon
    {
        ...
        {
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.White * 0.1f, Common.ColorSwap(Color.Aqua, Color.DodgerBlue, 1.5f), 4, CrystalVerticalFrameCount);
        }
