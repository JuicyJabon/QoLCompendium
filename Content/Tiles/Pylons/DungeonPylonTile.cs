...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class DungeonPylonTile : ModPylon
    {
        ...
        {
            crystalTexture = ModContent.Request<Texture2D>("QoLCompendium/Assets/PylonCrystals/DungeonPylonTile_Crystal", (AssetRequestMode)2);
            crystalHighlightTexture = ModContent.Request<Texture2D>("QoLCompendium/Assets/PylonCrystals/Highlight", (AssetRequestMode)2);
            mapIcon = ModContent.Request<Texture2D>("QoLCompendium/Assets/MapIcons/DungeonPylonTile_MapIcon", (AssetRequestMode)2);
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            TEModdedPylon instance = (TEModdedPylon)(object)ModContent.GetInstance<DungeonPylonTileEntity>();
        ...
        public override Entry GetNPCShopEntry()
        {
            ...
            {
                return new Entry(ModContent.ItemType<DungeonPylon>(), Condition.InDungeon);
            }
            return null;
        }
        ...
        {
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.White * 0.1f, ColorUtils.ColorSwap(Color.Aqua, Color.DodgerBlue, 1.5f), 4, CrystalVerticalFrameCount);
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(flag, pylonInfo, ModContent.GetInstance<DungeonPylon>().DisplayName.Key, ref mouseOverText);
        }
    }

    public class DungeonPylonTileEntity : TEModdedPylon
    {
