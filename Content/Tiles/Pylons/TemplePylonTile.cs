...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class TemplePylonTile : ModPylon
    {
        ...
        {
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(-1f, -12f), Color.White * 0.1f, Common.ColorSwap(Color.GreenYellow, Color.YellowGreen, 1.5f), 4, CrystalVerticalFrameCount);
        }
