...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class HellPylonTile : ModPylon
    {
        ...
        {
            DefaultDrawPylonCrystal(spriteBatch, i, j, crystalTexture, crystalHighlightTexture, new Vector2(0f, -12f), Color.White * 0.1f, ColorUtils.ColorSwap(Color.Orange, Color.OrangeRed, 1.5f), 4, CrystalVerticalFrameCount);
        }
