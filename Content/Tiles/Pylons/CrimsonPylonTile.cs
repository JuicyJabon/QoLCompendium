...
namespace QoLCompendium.Content.Tiles.Pylons
{
    public class CrimsonPylonTile : ModPylon
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            TEModdedPylon instance = (TEModdedPylon)(object)ModContent.GetInstance<CrimsonPylonTileEntity>();
            ...
            AddMapEntry(Color.Firebrick, val);
            DustType = -1;
        }
        ...
        public override Entry GetNPCShopEntry()
        {
            ...
            {
                return new Entry(ModContent.ItemType<CrimsonPylon>(), Condition.InCrimson);
            }
            return null;
        }
        ...
        public override void DrawMapIcon(ref MapOverlayDrawContext context, ref string mouseOverText, TeleportPylonInfo pylonInfo, bool isNearPylon, Color drawColor, float deselectedScale, float selectedScale)
        {
            ...
            DefaultMapClickHandle(flag, pylonInfo, ModContent.GetInstance<CrimsonPylon>().DisplayName.Key, ref mouseOverText);
        }
    }

    public class CrimsonPylonTileEntity : TEModdedPylon
    {
