    ...
    public class BMDealerNPC : ModNPC
    {
        ...
        public override void AddShops()
        {
            var potShop = new NPCShop(Type, "Potions")
                    ...
                    .Add(new Item(ItemID.LuckPotionLesser) { shopCustomPrice = Item.buyPrice(silver: 75) }, ModConditions.HasBeenToDesert)
                    ...
                    .Add(new Item(ItemID.LuckPotion) { shopCustomPrice = Item.buyPrice(silver: 75) }, ModConditions.HasBeenToDesert)
            ...
            var infoShop = new NPCShop(Type, "Informative/Building Gear")
                   ...
                   .Add(new Item(ItemID.StaffofRegrowth) { shopCustomPrice = Item.buyPrice(gold: 2) }, ModConditions.HasBeenToJungle)
                   ...
                   .Add(new Item(ItemID.RoyalGel) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedKingSlime, Condition.InExpertMode)
                   ...
                   .Add(new Item(ItemID.CorruptionKey) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedPlantera, ModConditions.HasBeenToEvil)
                   .Add(new Item(ItemID.CrimsonKey) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedPlantera, ModConditions.HasBeenToEvil)
                   .Add(new Item(ItemID.DungeonDesertKey) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedPlantera, ModConditions.HasBeenToDesert)
                   .Add(new Item(ItemID.FrozenKey) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedPlantera, ModConditions.HasBeenToSnow)
                   ...
                   .Add(new Item(ItemID.Sickle) { shopCustomPrice = Item.buyPrice(gold: 2) })
                   .Add(new Item(ItemID.LawnMower) { shopCustomPrice = Item.buyPrice(gold: 2) })
            ...
            var oreShop = new NPCShop(Type, "Ores & Bars")
                    ...
                    .Add(new Item(ItemID.FossilOre) { shopCustomPrice = Item.buyPrice(silver: 50) }, ModConditions.HasBeenToDesert)
            ...
            var naturalBlockShop = new NPCShop(Type, "Natural Blocks")
                    ...
                    .Add(new Item(ItemID.LeafWand) { shopCustomPrice = Item.buyPrice(gold: 5) })
                    .Add(new Item(ItemID.LivingWoodWand) { shopCustomPrice = Item.buyPrice(gold: 5) })
                    .Add(new Item(ItemID.LivingMahoganyLeafWand) { shopCustomPrice = Item.buyPrice(gold: 5) })
                    .Add(new Item(ItemID.LivingMahoganyWand) { shopCustomPrice = Item.buyPrice(gold: 5) })
                    .Add(new Item(ItemID.HiveWand) { shopCustomPrice = Item.buyPrice(gold: 5) }, Condition.DownedQueenBee)
                    .Add(new Item(ItemID.BoneWand) { shopCustomPrice = Item.buyPrice(gold: 5) }, Condition.DownedSkeletron)
                    .Add(new Item(ItemID.IceRod) { shopCustomPrice = Item.buyPrice(gold: 5) }, Condition.Hardmode)
                    .Add(new Item(ItemID.DirtRod) { shopCustomPrice = Item.buyPrice(gold: 5) }, Condition.DownedEyeOfCthulhu)
            ...
            var mountShop = new NPCShop(Type, "Mounts & Hooks")
                    ...
                    .Add(new Item(ItemID.FuzzyCarrot) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.PogoStick) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.GolfCart) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedSkeletron)
                    .Add(new Item(ItemID.MolluskWhistle) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.PaintedHorseSaddle) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.MajesticHorseSaddle) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.DarkHorseSaddle) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.SuperheatedBlood) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedEowOrBoc)
                    .Add(new Item(ItemID.AncientHorn) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.WolfMountItem) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.BlessedApple) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.ScalyTruffle) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    ...
                    .Add(new Item(ItemID.DarkMageBookMountItem) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedOldOnesArmyT1, Condition.InMasterMode)
                    .Add(new Item(ItemID.WallOfFleshGoatMountItem) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode, Condition.InMasterMode)
                    ...
                    .Add(new Item(ItemID.SapphireHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.EmeraldHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.AmberHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.RubyHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.DiamondHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.IvyWhip) { shopCustomPrice = Item.buyPrice(gold: 2) }, ModConditions.HasBeenToJungle)
                    .Add(new Item(ItemID.SlimeHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedKingSlime)
                    .Add(new Item(ItemID.FishHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.SquirrelHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.BatHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.CandyCaneHook) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.WebSlinger) { shopCustomPrice = Item.buyPrice(gold: 2) })
                    .Add(new Item(ItemID.SkeletronHand) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedSkeletron)
                    .Add(new Item(ItemID.DualHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.TendonHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.WormHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.IlluminantHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.Hardmode)
                    .Add(new Item(ItemID.QueenSlimeHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedQueenSlime)
                    .Add(new Item(ItemID.StaticHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedMechBossAny)
                    .Add(new Item(ItemID.ThornHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.SpookyHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedMourningWood)
                    .Add(new Item(ItemID.ChristmasHook) { shopCustomPrice = Item.buyPrice(gold: 2) }, Condition.DownedEverscream)
            ...
            var ammoShop = new NPCShop(Type, "Ammo")
                    ...
                    .Add(new Item(ItemID.PartyBullet) { shopCustomPrice = Item.buyPrice(copper: 1) })
                    .Add(new Item(ItemID.MeteorShot) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedEowOrBoc)
                    .Add(new Item(ItemID.CrystalBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.CursedBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.IchorBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.HighVelocityBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAny)
                    .Add(new Item(ItemID.GoldenBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.ExplodingBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.ChlorophyteBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAll)
                    .Add(new Item(ItemID.VenomBullet) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    ...
                    .Add(new Item(ItemID.HolyArrow) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.Hardmode)
                    .Add(new Item(ItemID.ChlorophyteArrow) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAll)
                    ...
                    .Add(new Item(ItemID.RocketIV) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.DryRocket) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.WetRocket) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.LavaRocket) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.HoneyRocket) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    .Add(new Item(ItemID.MiniNukeI) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedPlantera)
                    ...
                    .Add(new Item(ItemID.DirtSolution) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAny)
                    .Add(new Item(ItemID.PurpleSolution) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAny)
                    .Add(new Item(ItemID.RedSolution) { shopCustomPrice = Item.buyPrice(copper: 1) }, Condition.DownedMechBossAny)
