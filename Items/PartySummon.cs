...
namespace QoLCompendium.Items
{
    public class PartySummon : ModItem
    {
        ...
        public override bool CanUseItem(Player player)
        {
            ...
            {
                return Enumerable.Count(Main.npc, (NPC n) => n.active && n.townNPC && n.aiStyle != 0 && n.type != NPCID.OldMan && n.type != NPCID.SkeletonMerchant && n.type != NPCID.TaxCollector && !NPCID.Sets.IsTownPet[n.type]) >= 2;
            }
            return false;
        }
