...
{
    class DestinationGlobeUI : UIState
    {
        ...
        private void ResetBiomeClicked(UIMouseEvent evt, UIElement listeningElement)
        {
            ...
            p.GetQoLCPlayer().selectedBiome = 0;
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 1;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 2;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 3;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 4;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 5;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 6;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 7;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
        ...
        {
            Player p = Main.LocalPlayer;
            p.GetQoLCPlayer().selectedBiome = 8;
            SoundEngine.PlaySound(SoundID.MenuClose);
            visible = false;
        }
    }
