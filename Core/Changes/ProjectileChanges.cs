...
namespace QoLCompendium.Core.Changes
{
    public class ExtraLuresProjectile : GlobalProjectile
    {
        ...
        {
            if (projectile.bobber && projectile.owner == Main.myPlayer && QoLCompendium.mainServerConfig.ExtraLures && source is EntitySource_ItemUse)
            {
                int split = 1;
    ...
    public class NoSandDamage : GlobalProjectile
    {
        ...
        {
            if (QoLCompendium.mainServerConfig.NoFallingSandDamage)
            {
    ...
    public class HostileSandBallModifier : GlobalProjectile
    {
        ...
        {
            if (!projectile.friendly && QoLCompendium.mainServerConfig.NoLittering)
            {
        ...
        public override void OnKill(Projectile projectile, int timeLeft)
        {
            ...
            if (!QoLCompendium.mainServerConfig.NoLittering)
            {
                return;
            }
    ...
    public class RemoveTombstones : ModSystem
    {
        ...
        {
            if (!QoLCompendium.mainServerConfig.NoTombstoneDrops)
            {
