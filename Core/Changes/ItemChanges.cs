...
namespace QoLCompendium.Core.Changes
{
    public class DontConsumeSummons : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            else if (ModdedBossAndEventSummons.Contains(entity.type) && QoLCompendium.mainConfig.EndlessBossSummons)
            {
                return true;
            }
            return false;
...
#pragma warning restore CA2211
    ...
    public class CoinGItem : GlobalItem
    {
        public override void UpdateInventory(Item item, Player player)
        {
            if (CoinStacker.CoinTypes.Contains(item.type) && QoLCompendium.mainConfig.AutoMoneyQuickStack)
