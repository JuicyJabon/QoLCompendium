...
namespace QoLCompendium.Core.Changes.ModChanges.ModItemChanges
{
    ...
    public class CalamityRevertCrateDrops : GlobalItem
    {
        public override void ModifyItemLoot(Item item, ItemLoot itemLoot)
        {
            ...
            if (item.type == Common.GetModItem(CrossModSupport.Calamity.Mod, "AstralCrate") || item.type == Common.GetModItem(CrossModSupport.Calamity.Mod, "MonolithCrate"))
            {
            ...
            if (item.type == Common.GetModItem(CrossModSupport.Calamity.Mod, "BrimstoneCrate") || item.type == Common.GetModItem(CrossModSupport.Calamity.Mod, "SlagCrate"))
            {
                itemLoot.Add(ItemID.InfernoPotion, 10, 1, 3);
                itemLoot.Add(ItemID.Obsidian, 1, 2, 5);
                itemLoot.Add(ItemID.Hellstone, 4, 2, 5);

                itemLoot.Add(Common.GetModItem(CrossModSupport.Calamity.Mod, "DemonicBoneAsh"), 1, 1, 4);
                ...
                itemLoot.AddIf(Condition.Hardmode.IsMet, Common.GetModItem(CrossModSupport.Calamity.Mod, "EssenceofHavoc"), 10, 1, 3);
            }
            ...
            {
                itemLoot.Add(Common.GetModItem(CrossModSupport.Calamity.Mod, "MurkyPaste"), new Fraction(1, 5), 1, 3);
                ...
                MoonLord.Add(Common.GetModItem(CrossModSupport.Calamity.Mod, "EffulgentFeather"), new Fraction(5, 100), 5, 7);
