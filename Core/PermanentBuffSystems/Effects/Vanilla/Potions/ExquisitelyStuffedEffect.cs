namespace QoLCompendium.Core.PermanentBuffSystems.Effects.Vanilla.Potions
{
    public class ExquisitelyStuffedEffect : IPermanentBuff
    {
        ...
        {
            if (!player.Player.buffImmune[BuffID.WellFed3] && !player.Player.GetModPlayer<PermanentBuffPlayer>().PermanentBuffsBools[(int)PermanentBuffPlayer.PermanentBuffs.ExquisitelyStuffed])
            {
