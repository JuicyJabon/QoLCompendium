namespace QoLCompendium.Core.PermanentBuffSystems.Effects.Vanilla.Potions
{
    public class ShineEffect : IPermanentBuff
    {
        ...
        {
            if (!player.Player.buffImmune[BuffID.Shine] && !player.Player.GetModPlayer<PermanentBuffPlayer>().PermanentBuffsBools[(int)PermanentBuffPlayer.PermanentBuffs.Shine])
            {
