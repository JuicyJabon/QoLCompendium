namespace QoLCompendium.Core.PermanentBuffSystems.Effects.Vanilla.Potions
{
    public class TipsyEffect : IPermanentBuff
    {
        ...
        {
            if (!player.Player.buffImmune[BuffID.Tipsy] && !player.Player.GetModPlayer<PermanentBuffPlayer>().PermanentBuffsBools[(int)PermanentBuffPlayer.PermanentBuffs.Tipsy])
            {
