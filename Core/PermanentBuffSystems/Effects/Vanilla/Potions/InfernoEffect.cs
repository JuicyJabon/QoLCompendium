...
namespace QoLCompendium.Core.PermanentBuffSystems.Effects.Vanilla.Potions
{
    public class InfernoEffect : IPermanentBuff
    {
        ...
        {
            if (!player.Player.buffImmune[BuffID.Inferno] && !player.Player.GetModPlayer<PermanentBuffPlayer>().PermanentBuffsBools[(int)PermanentBuffPlayer.PermanentBuffs.Inferno])
            {
